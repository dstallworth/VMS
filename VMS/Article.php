...
class Article {
	...
	public function store() {
		...
		$insertSQL .= " (id,title,video_directory,caption,hovertext,maintext,filename,state,catid,created,created_by,related_article,modified,modified_by,checked_out," .
				"checked_out_time,publish_up,publish_down,version,parentid,ordering,metakey,metadesc,access,format_extension)";
		$insertSQL .= " values (";
		$insertSQL .= "null ,";
